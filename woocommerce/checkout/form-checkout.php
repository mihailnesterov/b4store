    ...
    <div class="row border">
        ...
        <div class="col-12 col-md-7 p-4">
            ...
            <div class="py-2 px-3 border">
                <h5 class="m-2"><i class="fa fa-check text-success mr-2"></i> Безналичный банковский платеж</h5>
                <!--<div class="form-check my-3">
            ...
            <div class="text-center text-md-left my-4">
                ...
                <button type="submit" class="btn btn-kp-yellow text-dark btn-lg px-4 shadow-md"><i class="fa fa-check text-kp-green mr-3"></i>Подтвердить заказ</button>
            </div>
        </div>
