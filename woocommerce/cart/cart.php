...
<div class="row">
    ...
    <header class="col-12 mb-4">
        <h1 class="text-center text-secondary"><i class="fa fa-shopping-basket text-kp-green mr-3 small"></i><?= the_title() ?></h1>
        						...
        						if ( $_product->is_sold_individually() ) {
        							...
        							$product_quantity = woocommerce_quantity_input(
        								array(
        									...
        									'classes'      => apply_filters( 'woocommerce_quantity_input_classes', array( 'input-text', 'qty', 'text', 'form-control','text-center','bg-light','font-weight-bold','w-50','mx-auto' ), $product ),
        								),
        								$_product,
        								false
        							);
